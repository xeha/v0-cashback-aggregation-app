...
CASES = [
    ...
    ("Яндекс Банк", "Яндекс Лавка", "Покупки в приложении банка", 1.0, True),
    ...
    ("Яндекс Банк", "Яндекс Плюс", "Покупки в приложении банка", 1.0, True),
    ("Т-Банк", "СберЗдоровье", "Медицина", 1.0, True),
