...
## Corpus Check
- 135 files · ~182,948 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 815 nodes · 1619 edges · 53 communities (46 shown, 7 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14be6114`
...
- `DuplicateConfirmState` --references--> `SourceSubmission`  [EXTRACTED]
  components/screens/bank-select-screen.tsx → lib/types.ts
- `BaseException` --uses--> `OcrItem`  [INFERRED]
  backend/services/ocr_service.py → backend/schemas.py
...
Cohesion: 0.06
Nodes (56): DuplicateSourceConfirmDialog(), formatProviderList(), ProviderKindPickerDialog(), ProviderKindPickerDialogProps, ProviderKindPickerMode, getPlaceholderAvatarColors(), getProviderInitial(), hashString() (+48 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (58): health(), lifespan(), _local_network_origin_regex(), Allow phone testing over Wi-Fi (Next.js dev on port 3000)., MapperService, Request, RetailerResolverService, BaseException (+50 more)
...
Cohesion: 0.05
Nodes (44): geistMono, geistSans, metadata, AppProviders(), CashbackApp(), EMPTY_PROCESSING_SUMMARY, getBankSelectInitialRows(), PickMode (+36 more)
...
Cohesion: 0.10
Nodes (27): ndarray, SentenceTransformer, CategoryMapRequestItem, MappedItem, MapperService, ndarray, main(), _normalize() (+19 more)
...
Cohesion: 0.19
Nodes (12): OcrFailureDialog(), isOcrRecognitionFailure(), ProcessSubmissionResult, BankOfferItem, CashbackMatrix, LowConfidenceItem, SourceSubmission, ActiveStep (+4 more)
...
## Knowledge Gaps
- **158 isolated node(s):** `geistSans`, `geistMono`, `metadata`, `Mistral`, `Path` (+153 more)
