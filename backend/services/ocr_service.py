...
Цель: категории трат на месяц. Это могут быть как общие типы покупок («Рестораны», «АЗС»), так и конкретные партнёрские бренды с кэшбэком («Дикси Доставка», «Отели на Туту», «Сварщица Екатерина»). Партнёрский бренд с процентом кэшбэка — валидная категория, включай её.
...
Что ВКЛЮЧАТЬ:
- Конкретные партнёрские бренды/магазины с кэшбэком: «17% Дикси Доставка», «50% Сварщица Екатерина», «20% Отели на Туту» — валидные категории, извлекай их
- Бонусные офферы банка: «100% Бесплатный Premium на 2 месяца», «Бесплатная подписка», «Бонус за покупки» — тоже извлекай, это отдельная категория привилегий банка
...
- Внутренние сервисы экосистемы банка (см. список ниже), даже если указан процент
