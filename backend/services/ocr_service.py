...
- НЕ выдумывай категории и проценты — извлекай только то, что явно видно на скриншоте
- В приложениях супермаркетов (Магнит, Пятёрочка и т.п.) категории часто товарные: «Молоко», «Твёрдые сыры», «Кисломолочка» — извлекай каждую строку списка отдельно, включая подписи вроде «Даже по акции» только если они часть названия категории"""
