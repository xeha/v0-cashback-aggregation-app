...
Что ВКЛЮЧАТЬ:
- Конкретные партнёрские бренды/магазины с кэшбэком: «17% Дикси Доставка», «50% Сварщица Екатерина», «20% Отели на Туту» — это ВАЛИДНЫЕ категории кэшбэка, извлекай их
...
- Бонусные офферы без трат: «100% Бесплатный Premium на 2 месяца», «Получи подписку», «Бонус за регистрацию» — это не кэшбэк на покупки
